...
\begin{lstlisting}[float,language={[LaTeX]TeX}, caption={Sample code for type setting small table.},label={lst:table-small}]
\begin{table}
    \centering
...
\begin{table}
    \centering
    \caption{This table has its caption above, too.}
    \begin{tabular}{ll} \toprule
