  ...
  \begin{titlepage}%
    ...
    \begin{minipage}[t][2.5cm][c]{0.8\linewidth}
      ...
      \ifdefempty{\@placeofbirth}{%
        ...
        \ThesisLocaleFrom\space{\usekomafont{placeofbirth}{\@placeofbirth}}\par%
      }%
    \end{minipage}
    \vspace*{1cm}\par%
    \begin{minipage}[t][1cm][c]{0.5\linewidth}
      \centering
      \ifdraft{\color{Red}{\bfseries\ttfamily\Huge\ThesisLocaleDraft}}{}
    \end{minipage}
    \vspace*{1cm}\par%
    \begin{minipage}[c][3cm][c]{0.75\linewidth}%
      ...
      \begin{tabu} to \linewidth {X[1,l] X[4,l]}%
        {\ThesisLocaleExaminer:}%
          & \@examiner\\%
        {\ThesisLocaleSupervisor:}%
          & {\@supervisor}\\%
        {\ThesisLocaleSubmittedon:}%
