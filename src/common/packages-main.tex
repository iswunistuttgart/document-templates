...
% The ti­tling pack­age pro­vides con­trol over the type­set­ting of the \maketi­tle com­mand and \thanks com­mands, and makes the \ti­tle, \au­thor and \date in­for­ma­tion per­ma­nently avail­able. Mul­ti­ple ti­tles are al­lowed in a sin­gle doc­u­ment. New ti­tling el­e­ments can be added and a ti­tlepage ti­tle can be cen­tered on a phys­i­cal page. 
