...
%%
% \DeclarePairedDelimiterX{\of}[1]{\lparen}{\rparen}{%
%   {#1}%
% }%
...
%%
\DeclareDocumentCommand{\transp}{ O{\mkern-1.5mu} m }{%
  #2^{#1\mbox{\textscale{0.6}{$\top$}}}%
}%
...
%%
\DeclareDocumentCommand{\hermconj}{ O{\mkern-1.5mu} m }{%
  #2^{#1\mbox{\textscale{0.6}{$\mathsf{H}$}}}%
}%
