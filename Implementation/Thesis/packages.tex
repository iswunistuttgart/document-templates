...
% The package manages culturally determined typographical (and other) rules, and hyphenation patterns for a wide range of languages
...
%   pdfhighlight=/N,
    ...
    menucolor=black,
    % Links zu anderen Seiten im Text: rot
    pagecolor=black,
    % URL-Farbe: rot
    urlcolor=black,
